...
ORDER_BLUEPRINT.add_url_rule('/api/v2/orders/<orderId>',view_func=ORDER_MANAGE, methods=['GET'])
ORDER_BLUEPRINT.add_url_rule('/api/v2/orders/<orderId>',view_func=ORDER_MANAGE, methods=['PUT'])